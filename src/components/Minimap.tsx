      ...
      <AnimatePresence>
        {isOpen ? (
          ...
          <motion.button
            ...
            className={cn(
              "flex items-center gap-2 px-4 py-3 rounded-2xl bg-indigo-500 text-white shadow-lg shadow-indigo-500/20 font-medium outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white",
            )}
          >
            <Map size={20} />
            <span>Show Map</span>
