      ...
      <AnimatePresence>
        {isOpen ? (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="p-1 rounded-lg hover:bg-white/5 text-white/40 hover:text-white transition-colors outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
              >
                <X size={16} />
              </button>
            </div>
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-indigo-500 text-white shadow-lg shadow-indigo-500/20 font-medium outline-none focus-visible:ring-2 focus-visible:ring-white"
          >
            <Map size={20} />
            <span>Show Map</span>
          </motion.button>
