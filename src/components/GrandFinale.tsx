      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button type="button" className={cn("flex items-center justify-center gap-3 py-5 rounded-2xl text-white font-bold text-lg hover:scale-[1.02] transition-transform outline-none focus-visible:ring-4 focus-visible:ring-white/20", themeBg)}>
              <Download size={24} />
              Download MP4
            </button>
            <button type="button" className="flex items-center justify-center gap-3 py-5 rounded-2xl bg-white/5 border border-white/10 text-white font-bold text-lg hover:bg-white/10 transition-colors outline-none focus-visible:ring-4 focus-visible:ring-white/20">
              <Share2 size={24} />
              Push to YouTube
            </button>
          </div>
          ...
          <button
            ...
            className="mt-12 flex items-center justify-center gap-2 mx-auto text-white/40 hover:text-white transition-colors outline-none focus-visible:underline"
          >
            <RefreshCcw size={18} />
            Run another project
          </button>
