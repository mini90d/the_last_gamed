        ...
        {productType && (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm flex items-center gap-2 outline-none focus-visible:ring-2 ring-indigo-500/50"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm outline-none focus-visible:ring-2 ring-indigo-500/50"
            >
