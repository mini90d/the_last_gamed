        ...
        {productType && (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm flex items-center gap-2 cursor-pointer focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm cursor-pointer focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none"
            >
