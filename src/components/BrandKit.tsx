      ...
      <div className="flex gap-2">
        {themes.map((t) => (
          <button
            ...
            title={t.name}
            className={cn(
              "h-6 w-6 rounded-full border-2 transition-all cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-black focus-visible:ring-white",
