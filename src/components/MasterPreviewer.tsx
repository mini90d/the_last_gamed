            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                   ...
                   className={cn(
                     "p-6 rounded-full text-white shadow-2xl transition-transform hover:scale-105 outline-none focus-visible:ring-2 focus-visible:ring-white/50",
                     themeBg
                   )}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                type="button"
                aria-label="Play video"
                className={cn("text-white transition-colors rounded-lg p-1 outline-none focus-visible:ring-1", themeHoverText, themeRing)}
              >
