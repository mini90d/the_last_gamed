            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={cn(
                      "p-6 rounded-full text-white shadow-2xl outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-black transition-transform",
                      themeBg,
                      themeRing
                    )}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                ...
                aria-label="Play"
                title="Play"
                className={cn("text-white transition-colors outline-none", themeHoverText)}
              >
