            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                    ...
                    className={cn(
                      "p-6 rounded-full text-white shadow-2xl transition-transform hover:scale-110 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none",
                      themeBg,
                      themeRing
                    )}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-1">
              <button
                type="button"
                aria-label="Play"
                className={cn("p-2 text-white transition-colors outline-none focus-visible:ring-1 rounded-lg", themeHoverText, themeRing)}
              >
