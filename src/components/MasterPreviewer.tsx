            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                   ...
                   className={cn("p-6 rounded-full text-white shadow-2xl transition-transform hover:scale-110 active:scale-95 outline-none focus-visible:ring-4 cursor-pointer", themeBg, themeRing)}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                ...
                className={cn("text-white transition-colors outline-none focus-visible:ring-2 rounded-lg p-1 cursor-pointer", themeHoverText, themeRing)}
              >
                <Play size={18} />
              </button>
              <button
