            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                   ...
                   className={cn("p-6 rounded-full text-white shadow-2xl cursor-pointer hover:scale-110 transition-transform focus-visible:ring-2 outline-none", themeBg, themeFocusRing)}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                type="button"
                aria-label="Play video"
                className={cn("text-white cursor-pointer transition-colors outline-none focus-visible:ring-2 rounded-sm", themeHoverText, themeFocusRing)}
              >
                <Play size={18} />
              </button>
              <button
