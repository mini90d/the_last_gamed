        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                ...
                className={cn("p-1 rounded-md transition-colors outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 text-white cursor-pointer", themeHoverText)}
              >
                <Play size={18} />
              </button>
              <button
