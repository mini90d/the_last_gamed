            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                    ...
                    className={cn("p-6 rounded-full text-white shadow-2xl transition-transform hover:scale-110 active:scale-95 outline-none focus-visible:ring-4 ring-white/50", themeBg)}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-1">
              <button
                type="button"
                aria-label="Play video"
                className={cn("text-white transition-colors outline-none focus-visible:ring-2 rounded-lg p-2", themeHoverText, themeRing)}
              >
