...
export const MasterPreviewer: React.FC = () => {
  ...
  return (
    <div className="relative h-full w-full rounded-3xl overflow-hidden bg-black border border-white/10 group focus-within:ring-0">
      {/* Video Preview Area */}
      ...
      {/* Controls Overlay */}
      <div className="absolute bottom-0 inset-x-0 p-4 translate-y-full group-hover:translate-y-0 group-focus-within:translate-y-0 focus-within:translate-y-0 transition-transform bg-gradient-to-t from-black/80 to-transparent">
        <div className="flex items-center justify-between">
           <div className="flex gap-1">
              <button
                type="button"
                aria-label="Play video"
                className={cn("p-2 rounded-lg text-white transition-colors outline-none focus-visible:ring-2 cursor-pointer", themeHoverText, themeRing)}
              >
