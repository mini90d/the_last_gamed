            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                  ...
                  className={cn(
                    "p-6 rounded-full text-white shadow-2xl transition-transform hover:scale-110 outline-none focus-visible:ring-4 focus-visible:ring-white/50 cursor-pointer",
                    themeBg
                  )}
                >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                type="button"
                aria-label="Play video"
                className={cn("text-white p-1 rounded-lg outline-none focus-visible:ring-1 transition-colors cursor-pointer", themeHoverText, themeRing)}
              >
