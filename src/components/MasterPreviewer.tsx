            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <button
                    ...
                    className={cn("p-6 rounded-full text-white shadow-2xl outline-none focus-visible:ring-2 ring-white/50 transition-all hover:scale-110", themeBg)}
                 >
        ...
        <div className="flex items-center justify-between">
           <div className="flex gap-4">
              <button
                type="button"
                aria-label="Play video"
                 className={cn("text-white hover:text-indigo-400 cursor-pointer outline-none transition-colors focus-visible:ring-2 rounded-lg p-1", themeRing)}
              >
                <Play size={18} />
              </button>
              <button
